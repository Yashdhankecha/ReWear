  ...
  <footer className="w-full bg-slate-900 text-slate-200 pt-12 pb-4 mt-12 shadow-inner shadow-blue-900/30">
    <div className="max-w-7xl mx-auto flex flex-wrap justify-between gap-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex-1 min-w-[200px] mb-8">
        <div className="font-bold text-2xl mb-2 text-white tracking-wide">ReWear</div>
      ...
      <div className="flex-1 min-w-[150px] mb-8">
        ...
        <ul>
          <li><Link to="/how-it-works" className="block text-slate-300 hover:text-blue-500 transition-colors mb-1">How It Works</Link></li>
          <li><Link to="/browse" className="block text-slate-300 hover:text-blue-500 transition-colors mb-1">Browse Items</Link></li>
          <li><Link to="/list" className="block text-slate-300 hover:text-blue-500 transition-colors mb-1">List an Item</Link></li>
          <li><Link to="/points" className="block text-slate-300 hover:text-blue-500 transition-colors">Points System</Link></li>
        </ul>
      </div>
      {/* Company Links */}
      <div className="flex-1 min-w-[150px] mb-8">
        ...
        <ul>
          <li><Link to="/about" className="block text-slate-300 hover:text-blue-500 transition-colors mb-1">About Us</Link></li>
          <li><Link to="/contact" className="block text-slate-300 hover:text-blue-500 transition-colors mb-1">Contact</Link></li>
          <li><Link to="/privacy" className="block text-slate-300 hover:text-blue-500 transition-colors mb-1">Privacy Policy</Link></li>
          <li><Link to="/terms" className="block text-slate-300 hover:text-blue-500 transition-colors">Terms of Service</Link></li>
        </ul>
      </div>
      {/* Newsletter */}
      <div className="flex-1 min-w-[200px] mb-8">
        ...
        <form className="flex">
          <input
            ...
            className="px-4 py-2 rounded-l-lg bg-slate-800 text-white border-none focus:ring-2 focus:ring-blue-500 outline-none text-base placeholder-slate-400"
          />
          <button
            type="submit"
            className="bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:ring-blue-400 text-white font-semibold px-4 py-2 rounded-r-lg transition-all shadow shadow-blue-900/20"
          >
            Subscribe
          </button>
        </form>
