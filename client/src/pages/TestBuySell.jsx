...
const TestBuySell = () => {
  ...
  const setupTestData = async () => {
    try {
      setLoading(true);
      const response = await axios.post('/api/dashboard/test/setup-buy-sell');
  ...
  const addTransactionData = async () => {
    try {
      ...
      const response = await axios.post('/api/dashboard/test/add-transaction-data');
  ...
  const createDiverseData = async () => {
    try {
      ...
      const response = await axios.post('/api/dashboard/test/create-diverse-data');
