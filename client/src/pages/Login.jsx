        ...
        <div className="hidden lg:block space-y-8">
          <div className="space-y-6">
            ...
            <h1 className="text-6xl font-bold bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent leading-tight">
              Sustainable<br />
              <span className="text-white">Fashion</span><br />
              Platform
            </h1>
            <p className="text-xl text-gray-300 leading-relaxed max-w-md">
              Join ReWear and be part of the sustainable fashion revolution. 
              Reduce waste, save money, and look great while helping the planet.
            </p>
          ...
          <div className="bg-dark-800/50 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-dark-700/50">
            <div className="text-center mb-8">
              <div className="mb-6">
                ...
                <p className="text-gray-400 font-medium">Sign in to your ReWear account</p>
              </div>
            </div>
