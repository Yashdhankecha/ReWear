...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 py-16 px-4" style={{ width: '100vw' }}>
              ...
              <div className="mt-8 pt-6 border-t border-slate-600">
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 font-medium"
                  >
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-600 shadow-xl">
              ...
              {loadingProducts ? (
                    ...
                    <div key={product._id} className="bg-slate-700/50 rounded-xl p-6 border border-slate-600 hover:border-slate-500 transition-colors">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-blue-400 font-medium">{product.points} points</span>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-slate-400 text-sm">Start sharing your clothes with the community!</p>
                  <button
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-600 shadow-xl">
              ...
              {loadingProducts ? (
                    ...
                    <div key={product._id} className="bg-slate-700/50 rounded-xl p-6 border border-slate-600 hover:border-slate-500 transition-colors">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-slate-400 text-sm mb-2">{product.brand} • {product.size}</p>
                          <div className="flex items-center justify-between">
                            <span className="text-green-400 font-medium">{product.points} points</span>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-slate-400 text-sm">Start browsing and swapping for new clothes!</p>
                  <button
